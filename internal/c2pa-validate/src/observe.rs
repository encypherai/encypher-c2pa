...
pub struct Metrics {
    ...
    /// Verify calls that returned a [`crate::ValidateError`].
...
impl Metrics {
    ...
    pub fn record_state(&self, state: crate::ValidationState) {
        self.verifications.fetch_add(1, Ordering::Relaxed);
        match state {
            crate::ValidationState::Trusted => &self.trusted,
            crate::ValidationState::Valid => &self.valid,
            crate::ValidationState::Invalid => &self.invalid,
            // No provenance: count alongside the other no-manifest outcomes.
            crate::ValidationState::None => &self.no_manifest,
        }
