...
Fragmented verification takes the signed initialization segment and any available subset of media segments. Both fMP4 and CMAF use `video/mp4`; they are verification modes, not additional MIME types.
