...
The `c2pa-2.4` profile exposes 68 canonical MIME types. Run `encypher-c2pa formats` to read the list from the installed build.
...
`application/font-sfnt`, `application/javascript`, `application/json`, `application/toml`, `application/xhtml+xml`, `application/xml`, `application/yaml`, `application/x-font-ttf`, `font/otf`, `font/sfnt`, `font/ttf`, `text/css`, `text/csv`, `text/html`, `text/markdown`, `text/plain`, `text/xml`
